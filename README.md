...
Зарегистрируйтесь на сервисе для публикации и размещения статических сайтов **Netlify**,
...
После завершения загрузки данных и появления на сервисе ссылки на ваш готовый сайт с 3Dмоделью, переименуйте сайт так, чтобы ссылка на него была более удобочитаемой.
...
Сгенерируйте html-ссылку на ваш сайт с 3D-моделью, переименуйте ее и отправьте ссылку  
в личный чат преподавателя в MS Teams для проверки результата вашей работы.
