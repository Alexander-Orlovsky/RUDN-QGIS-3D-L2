...
<br><br>
Создайте на своем компьютере в корне диска «C:» (или диска «D:») рабочую папку с названием «**Work_Dir_3D**» и все скачиваемые и создаваемые данные помещайте **только в эту папку**.
...
<br><br><br><br>
Что за слои имеются в QGIS-проекте - РАСПИСАТЬ
<br><br><br><br>
...
Скачайте QLR-файл (QGIS Layer Definition File, описание слоя) «Дополнительные сервисы космоснимков.qlr» по 
