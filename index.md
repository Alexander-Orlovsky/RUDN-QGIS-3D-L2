...
Скачайте QLR-файл (QGIS Layer Definition File, файл описания слоя) «**Дополнительные сервисы космоснимков.qlr**» по 
...
<br>
> #### ***Важная информация и рекомендация:***
> *Обратите особое внимание, что настройки, сделанные вами в модуле Qgis2threejs, сохраняются в отдельный файл настроек с расширением \*.qto3settings и именем,* 
> *как у самого вашего QGIS&#8209;проекта и рядом с ним (в том же месте, где расположен и файл QGIS&#8209;проекта).
> СОХРАНЕНИЕ ПРОИСХОДИТ **В МОМЕНТ ЗАКРЫТИЯ** окна модуля Qgis2threejs.*
> 
> *Когда вы откроете модуль Qgis2threejs позже, все сохраненные для него настройки 3D&#8209;экспорта будут восстановлены.
> Поэтому, после внесения каких-либо изменений в настройки 3D&#8209;экспорта, обязательно периодически закрывайте модуль Qgis2threejs сохраняя таким образом 
...
> Еще правильнее и надежнее, если дополнительно вы будете периодически сохранять отдельную резервную копию актуального файла \*.qto3settings ваших настроек 3D&#8209;экспорта.*
