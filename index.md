...
Для этого в «Qgis2threejs Exporter», не изменяя уже выбранного вами начального ракурса 3D&#8209;модели, в панели «**Animation**» щелкните левой клавишей мыши по «**Camera&nbsp;Motion**» 
...
Отправьте сгенерированную и переименованную **html&#8209;ссылку** на ваш сайт с 3D&#8209;моделью в личный&nbsp;чат преподавателя в **MS&nbsp;Teams** для проверки и оценки результатов вашей работы.
...
Перед отправкой результатов работы на проверку преподавателем обязательно убедитесь, что оформление созданной вами карты значительных изменений растительного покрова полностью соответствует образцу, имеющемуся в комплекте учебных материалов.
...
Перед отправкой данного ZIP-файла с финальным векторным слоем NDVI на проверку преподавателем, обязательно убедитесь, что
